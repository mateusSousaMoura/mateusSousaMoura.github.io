...
import { SiReact, SiTypescript, SiNodedotjs, SiJavascript, SiGit, SiPostgresql, SiNextdotjs, SiTailwindcss, SiSpring, SiRubyonrails, SiDocker } from 'react-icons/si';
                ...
                <div>
                  <div className="flex flex-wrap items-center gap-4">
                    {group.items.map((it) => {
                      ...
                      return (
                        <div key={it.key} className="flex items-center space-x-3 px-3 py-2 rounded-md bg-foreground border border-muted text-main">
                          <div className="w-10 h-10 flex items-center justify-center rounded-md bg-main">
                            {isNext ? (
